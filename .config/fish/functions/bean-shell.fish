...
../collect-beans/categorise-and-insert.sh CONFIG.yaml 2021.beancount collected_beans_transactions.db
# use 'Git: Open Changes' in VS Code to see what was inserted

# Update balances
python ../collect-beans/collector.py CONFIG.yaml --balance
../collect-beans/categorise-and-insert.sh CONFIG.yaml 2021.beancount collected_beans_balance.db
